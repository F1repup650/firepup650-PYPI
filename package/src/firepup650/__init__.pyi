...
def gh(keycount: int = ..., chars: list = ..., char: str = ..., bytes: bool = ...) -> None: ...
...
def Color(r: int = ..., g: int = ..., b: int = ..., bcolor: bool = ..., flush: bool = ...) -> None: ...
...
def replitInput(prompt: str = ..., cast: Type = ..., badCastMessage: str = ...) -> cast: ...
